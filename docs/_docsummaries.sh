...
python docs/_summarize_module.py summarize-module "oumi.datasets" --parent-class "oumi.core.datasets.BaseLMSftDataset" --filter-type "class" --output-file docs/api/summary/sft_datasets.md
